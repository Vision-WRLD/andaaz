...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      style={{ backgroundColor: "rgba(250,246,241,0.92)", borderColor: "var(--border-warm)" }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-20">
          {/* Logo — two lines, always neutral, gold only on hover */}
          <Link
            to="/"
            className="flex-shrink-0 transition-colors duration-300 mr-12 lg:mr-16"
